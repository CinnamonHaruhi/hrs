...
CREATE TABLE `reservations` (
  ...
  KEY `room_id` (`room_id`),
  CONSTRAINT `reservations_ibfk_1` FOREIGN KEY (`occupant_id`) REFERENCES `occupants` (`occupant_id`),
...
INSERT INTO `reservations` VALUES ('QECQRQN5',2,'2',102,'2026-01-09','2026-01-10',1000,'Approved'),('XB3EW8AY',3,'2',102,'2026-01-09','2026-01-09',1000,'Pending');
